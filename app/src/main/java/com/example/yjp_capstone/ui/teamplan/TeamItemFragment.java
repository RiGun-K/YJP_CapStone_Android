...
public class TeamItemFragment extends Fragment {
    ...
    private TeamItemViewModel mViewModel;

    public static TeamItemFragment newInstance() {
        return new TeamItemFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_team_item, container, false);
    }
